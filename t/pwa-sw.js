const CACHE='armaghan-ux-v2-20260919';
const CORE=['./index.htm','./shared-v2/catalog.css','./shared-v2/catalog.js','./shared-v2/icon.svg','./08/index.htm','./09/index.htm','./10/index.htm'];
