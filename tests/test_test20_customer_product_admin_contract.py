...
assert "../../t/20" in vite or "../../t/21" in vite or "../../t/22" in vite or "../../t/23" in vite or "../../t/24" in vite
assert ("test20-build" in workflow and "t/20" in workflow) or ("test21-build" in workflow and "t/21" in workflow) or ("test22-build" in workflow and "t/22" in workflow) or ("test23-build" in workflow and "t/23" in workflow) or ("test24-build" in workflow and "t/24" in workflow)
...
for key_file in [
    ...
    assert "test20" in text or "test21" in text or "test22" in text or "test23" in text or "test24" in text or "armaghan:locale:manual" in text
