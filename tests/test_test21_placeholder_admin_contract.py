...
assert "../../t/21" in vite or "../../t/22" in vite
assert ("test21-build" in workflow and "t/21" in workflow) or ("test22-build" in workflow and "t/22" in workflow)
...
assert "armaghan:test21:placeholder-set" in design or "armaghan:test22:placeholder-set" in design
...
for key_file in [
    ...
    assert "test21" in key_file.read_text(encoding="utf-8") or "test22" in key_file.read_text(encoding="utf-8")
